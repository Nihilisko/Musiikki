...
| 9 | Teoria | Teoriasivu valikosta. (a) ✅ capo- ja transponointilaskin: soinnut tekstinä (myös H = B), sävellajin tunnistus, transponointi puolisävelaskelin, capo ja helpoimpien capo-paikkojen ehdotukset. (b) ✅ sävellajin soinnut: duuri, molli ja harmoninen molli, kolmi- ja nelisoinnut, funktiot (T/S/D) väreineen, napautus avaa otteet sointukirjassa. (c) teoriamuistiot linkkeineen |

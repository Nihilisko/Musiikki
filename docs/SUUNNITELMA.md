...
| 12 | Korvaharjoitukset | Valikon ruutu Ear training. (a) ✅ intervallit: ✅ pala 1 – pianolla (itse tehdyt sävelet C3–C6), tasot 1–5 (kvartti/kvintti/oktaavi → kaikki 12), suunta ylös/alas/yhtä aikaa/sekaisin, pisteet ja putki, muistilaulut; ✅ pala 2 – oma valinta (Custom, vähintään 2 intervallia), väli näytetään vastauksen jälkeen omalla soittimella ja vireellä (helpoin paikka, tarvittaessa oktaavia siirrettynä), tilastot tasoittain tallentuvat ja 17/20 viimeisestä oikein ehdottaa seuraavaa tasoa. Myöhemmin soittimen ääni. (b) sointutyypit, (c) sävelet, (d) harmonisointi |

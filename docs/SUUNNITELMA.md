...
| 11 | Taustasoitto | Valikon ruutu Backing tracks. (a) ✅ drone: pehmeä urkumainen ääni (itse tehdyt saumattomat silmukat C3–F♯4), kvintti päälle/pois, voimakkuus, pehmeä häivytys; drone-nappi myös skaalasivulla. (b) ✅ sointukierrot rumpukompeilla (Chord progressions): itse tehty akustinen piano C3–C5 ja rummut, kompit Rock, Blues shuffle, Pop/ballad ja Jazz swing (triolipohjainen svengi), kierroilla oma tahtimuoto (12-tahtinen blues) ja sopiva oletuskomppi, 4 iskun sisäänlaskenta, soiva tahti korostettuna. (c) bassolinjat (basso). (d) rämpytyskuviot (ukulele) |
